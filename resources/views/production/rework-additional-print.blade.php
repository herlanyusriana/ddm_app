...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .sheet { border:1.5px solid #111; height:190mm; padding:10mm 12mm; width:100%; }
        .header { display:grid; grid-template-columns:75mm 1fr 55mm; min-height:34mm; }
        .meta { align-self:end; display:grid; gap:4px; }
        .meta-row { display:grid; grid-template-columns:24mm 5mm 1fr; }
        .title { align-self:center; font-size:24px; font-weight:900; text-align:center; text-decoration:underline; }
        .company { align-self:start; display:grid; justify-items:center; line-height:1.35; text-align:left; }
        .stamp { align-items:center; border:1.5px solid #111; border-radius:50%; display:flex; font-size:8px; font-weight:800; height:24mm; justify-content:center; line-height:1.25; text-align:center; width:24mm; }
        .company-text { justify-self:stretch; margin-top:2mm; }
        .from-line { font-weight:700; margin:0 0 2mm 0; text-align:right; width:100%; }
        table.form { border-collapse:collapse; table-layout:fixed; width:100%; }
        .form th, .form td { border:1.2px solid #111; height:10mm; padding:3px 5px; vertical-align:middle; }
        ...
        .footer { align-items:end; display:grid; grid-template-columns:58mm 1fr; gap:8mm; margin-top:4mm; }
        .doc { font-weight:800; height:24mm; writing-mode:vertical-rl; transform:rotate(180deg); }
        .signatures { align-self:end; border-collapse:collapse; table-layout:fixed; width:92mm; }
        .signatures td { border:1.2px solid #111; height:20mm; padding-top:2mm; text-align:center; vertical-align:top; }
        @media print {
